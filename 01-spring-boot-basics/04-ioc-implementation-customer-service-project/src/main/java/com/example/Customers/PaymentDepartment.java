...
public class PaymentDepartment implements CustomerCare {
    ...
    public void getService() {
        ...
        System.out.println("How may I assist you with your payment query?");
    }
    ...
    public void getProblem() {
        System.out.println("Dear " + this .customerName + " your issue for \" " + this.issue + "\" is registered with Payments");
